...
import sayaradz.authentification.databinding.ActivityMesAnnoncesBinding
...
class MesAnnoncesActivity : AppCompatActivity() {
    ...
    val TAG = "TAG-MesAnnoncesActivity"
     private lateinit var binding: ActivityMesAnnoncesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* setContentView(R.layout.activity_mes_annonces)
        ...
        btn_add_anc.setOnClickListener {
